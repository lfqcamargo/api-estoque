...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('mate', [
      ...
      { mate_dsc: "Alicate de Corte", grup_id: 1, user_id: 6, mate_dat_cria: new Date(), mate_dat_atua: new Date() },
      { mate_dsc: "Alicate de Bico", grup_id: 1, user_id: 6, mate_dat_cria: new Date(), mate_dat_atua: new Date() },
      { mate_dsc: "Alicate de Pressão", grup_id: 1, user_id: 6, mate_dat_cria: new Date(), mate_dat_atua: new Date() },
      { mate_dsc: "Alicate Universal", grup_id: 1, user_id: 6, mate_dat_cria: new Date(), mate_dat_atua: new Date() },
      { mate_dsc: "Parafuso 5x30", grup_id: 2, user_id: 6, mate_dat_cria: new Date(), mate_dat_atua: new Date() },
      { mate_dsc: "Parafuso 6x40", grup_id: 2, user_id: 6, mate_dat_cria: new Date(), mate_dat_atua: new Date() },
      { mate_dsc: "Parafuso 8x50", grup_id: 2, user_id: 6, mate_dat_cria: new Date(), mate_dat_atua: new Date() },
