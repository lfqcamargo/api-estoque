...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('grup', [
      { grup_dsc: "Alicate", user_id: 2, grup_dat_cria: new Date(), grup_dat_atua: new Date() },
      { grup_dsc: "Parafuso", user_id: 2, grup_dat_cria: new Date(), grup_dat_atua: new Date() },
      { grup_dsc: "Porca", user_id: 6, grup_dat_cria: new Date(), grup_dat_atua: new Date() },
      { grup_dsc: "Arruela", user_id: 6, grup_dat_cria: new Date(), grup_dat_atua: new Date() },
